...
Upon Execution of the Bash script, it should give you an idea of progress. This is arbitrary as the job
...
There are 32 unique combinations. Kernel Ridge is also engaged for this code and can be
